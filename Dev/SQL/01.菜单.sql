...
delete t_DataFlowDetailFunc where FDetailFuncID = 80010000
INSERT INTO t_DataFlowDetailFunc
           (FDetailFuncID,FFuncName,FFuncName_CHT,FFuncName_EN,FSubFuncID
           ,FIndex,FClassName,FClassParam,FIsNormal,FHelpCode
           ,FVisible,FAcctType,FFuncType,FEnable,FShowName
           ,FShowName_CHT,FShowName_EN,FIsEdit,FShowSysType,FUrl
           ,FUrlType,FFuncType_Ex)
     VALUES (80010000,'车型物料配置-维护','车型物料配置-维护','车型物料配置-维护',800100,
...
--整车管理_整车采购_采购验收
delete t_DataFlowSubFunc where FSubFuncID = 801101
INSERT INTO t_DataFlowSubFunc
           (FSubFuncID,FSubSysID,FIndex,FFuncName,FFuncName_CHT
           ,FFuncName_EN,FClassName,FClassParam,FVisible,FAcctType
           ,FFuncType,FRefresh,FSetEnable,FSubID,FIsEdit
           ,FShowSysType,FUrl,FUrlType)
     VALUES(801101,8011,1,'采购验收','采购验收',
			'采购验收','','',1,'',
			0,0,0,null,0,
			1,'','')	 
			
--整车管理_整车采购_采购验收_整车验收单 - 维护			
delete t_DataFlowDetailFunc where FDetailFuncID = 80110100
INSERT INTO t_DataFlowDetailFunc
           (FDetailFuncID,FFuncName,FFuncName_CHT,FFuncName_EN,FSubFuncID
           ,FIndex,FClassName,FClassParam,FIsNormal,FHelpCode
           ,FVisible,FAcctType,FFuncType,FEnable,FShowName
           ,FShowName_CHT,FShowName_EN,FIsEdit,FShowSysType,FUrl
           ,FUrlType,FFuncType_Ex)
     VALUES (80110100,'整车验收单 - 维护','整车验收单 - 维护','整车验收单 - 维护',801101,
			1,'K3BOSActive.Application','List|200000038',1,'',
			1,'',0,1,null,
			null,null,1,1,'ExtBOS/Filter/BOSListManager.aspx?FClassTypeID=200000038',
			'newtab','list')
--整车管理_整车采购_采购验收_整车验收单 - 新增
delete t_DataFlowDetailFunc where FDetailFuncID = 80110101
INSERT INTO t_DataFlowDetailFunc
           (FDetailFuncID,FFuncName,FFuncName_CHT,FFuncName_EN,FSubFuncID
           ,FIndex,FClassName,FClassParam,FIsNormal,FHelpCode
           ,FVisible,FAcctType,FFuncType,FEnable,FShowName
           ,FShowName_CHT,FShowName_EN,FIsEdit,FShowSysType,FUrl
           ,FUrlType,FFuncType_Ex)
     VALUES (80110101,'整车验收单 - 新增','整车验收单 - 新增','整车验收单 - 新增',801101,
			2,'K3BOSActive.Application','Bill|200000038',1,'',
			1,'',0,1,null,
			null,null,1,1,'ExtBOS/BillEdit.aspx?FClassTypeID=200000038',
			'newtab','base')
...
---精品管理
delete t_DataFlowTopClass where FTopClassID=802
INSERT INTO t_DataFlowTopClass(FTopClassID,FTopClassName,FTopClassName_EN,FTopClassName_CHT,FIndex,
					FVisible,FAcctType,FToolTips,FToolTips_CHT ,FToolTips_EN,
					FShowSysType)
values (802,'精品管理','精品管理','精品管理',0,
		1,',1,',null,null,null,
		1)
		
--精品管理_精品采购
delete t_DataFlowSubSystem where FSubSysID=80201
INSERT INTO t_DataFlowSubSystem(FSubSysID,FName,FName_CHT ,FName_EN ,FTopClassID,
			FClassName,FIndex,FVisible ,FAcctType,FRefresh,
			FNote,FNote_CHT,FNote_EN,FAppClassName,FHelpFileName,
			FTipID,FUpdateBaseData,FSubID,FIsEdit,FSubSystemID,
			FShowSysType,FUrl,FUrlType)
     VALUES(80201,'精品采购','精品采购','精品采购',802,
     'K3BOSActive.Application',0,1,',1,',0,
     null,null,null,null,null,
     0,0,'',0,80201,
     1,'','')
...
--精品管理_精品库存
delete t_DataFlowSubSystem where FSubSysID=80202
INSERT INTO t_DataFlowSubSystem(FSubSysID,FName,FName_CHT ,FName_EN ,FTopClassID,
			FClassName,FIndex,FVisible ,FAcctType,FRefresh,
			FNote,FNote_CHT,FNote_EN,FAppClassName,FHelpFileName,
			FTipID,FUpdateBaseData,FSubID,FIsEdit,FSubSystemID,
			FShowSysType,FUrl,FUrlType)
     VALUES(80202,'精品库存','精品库存','精品库存',802,
     'K3BOSActive.Application',1,1,',1,',0,
     null,null,null,null,null,
     0,0,'',0,80202,
     1,'','')
	 
--精品管理_精品销售
delete t_DataFlowSubSystem where FSubSysID=80203
INSERT INTO t_DataFlowSubSystem(FSubSysID,FName,FName_CHT ,FName_EN ,FTopClassID,
			FClassName,FIndex,FVisible ,FAcctType,FRefresh,
			FNote,FNote_CHT,FNote_EN,FAppClassName,FHelpFileName,
			FTipID,FUpdateBaseData,FSubID,FIsEdit,FSubSystemID,
			FShowSysType,FUrl,FUrlType)
     VALUES(80203,'精品销售','精品销售','精品销售',802,
     'K3BOSActive.Application',2,1,',1,',0,
     null,null,null,null,null,
     0,0,'',0,80203,
     1,'','')
